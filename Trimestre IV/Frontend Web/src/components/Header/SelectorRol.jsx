...
export default function SelectorRol({ rol }) {
  ...
  // Se normaliza la ruta (minúsculas y sin "/" final). Se acepta cualquier
  // ruta de /admin que contenga "horarios" o "calendario", así no depende
  // de la ruta exacta ni de subrutas (/admin/horarios/algo).
